...
import { has, shape, Any, ID, ObjectID, Optional, Integer, Double, AnyOf, REQUIRED, _getParams } from './lib/shape';
...
export { check, pick, has, shape, Any, ID, ObjectID, Optional, Integer, Double, AnyOf, _getParams, EasySchema };
